        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-2">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-xl font-bold tracking-tighter text-white">NovaAI</span>
            </div>
            <p className="text-gray-500 max-w-sm mb-6">
              The world's most advanced AI productivity platform designed for students, 
              developers, and forward-thinking teams.
            </p>
            <div className="flex space-x-4">
              {[
                ...
                <a key={social.name} href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-violet-600 transition-colors">
